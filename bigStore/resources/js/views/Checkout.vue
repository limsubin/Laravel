            ...
            <div class="col-md-8 offset-md-2">
                ...
                <div>
                  <div v-if="!isLoggedIn">
                    ...
                    <button class="col-md-4 btn btn-danger float-right" @clik="register">Create an account</button>
                  </div>

                  <div v-if="isLoggedIn">
                      <label for="address" class="clo-md-3 col-form-label">Dilivery Address</label>
                      <div class="col-md-9">
...
export default {
    ...
    //제품 정보를 가져오는 방법
    beforeMount(){
        axios.get('/api/product/${this.pid}').then(response => this.product = response.data)
    ...
    methods:{
        ...
        placeOrder(e){
            ...
            axios.post('api/orders/', {address, quantity, product_id}).then(response => this.$router.push('/confirmation'))
