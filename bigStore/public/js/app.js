...
//
//
//사용자, 주문 및 제품에 대한 API를 호출하고 데이터를 반환
  ...
  methods: {
    ...
    deliver: function deliver(index) {
      ...
      axios.patch('/api/orders/' + order.id + '/deliver').then(function (response) {
        ...
        _this2.$forceUpdate(); //페이지에 즉시 반영되도록 변경사항을 반영하기 위해 호출
...
//
//
//모달이 product데이터를 받으면 각 필드에 데이터를 미리 채웁니다
//이미지를 첨부하고 모달의 양식을 제출하면 이미지가 업로드되고 이미지의 URL이 반환
//제품의 이미지 속성을 URL로 업데이트한 다음 close이벤트를 내보내서 제품을 반환
//첨부된 이미지가 없으면 우리는 close이벤트를 내보내고 함께 제품데이터를 반환
/* harmony default export */ __webpack_exports__["default"] = ({
  props: ['product'],
  data: function data() {
    return {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  beforeMount: function beforeMount() {
    ...
    axios.get('/api/products/').them(function (response) {
      return _this.products = response.data;
    });
  },
  methods: {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  beforeMount: function beforeMount() {
    ...
    axios.defaults.headers.common['Contnet-Type'] = 'application/json';
    axios.defaults.headers.common['Authorication'] = 'Bearer' + localStorage.getItem('bigStore.jwt');
  },
  //구성 요소간 전환을 위한 탐색 정의
  methods: {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  beforeMount: function beforeMount() {
    ...
    axios.get('/api/product/${this.pid}').then(function (response) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    handleSubmit: function handleSubmit(e) {
      ...
      e.preventDefault(); //인증에 성공하면 : 액세스 토큰, 사용자 데이터 저장
      //localStorage앱 전반에 액세스 할 수 있도록한다

      if (this.password.length > 0) {
        var email = this.email;
        var password = this.password; //alert(email+","+password)
        ...
        axios.post('api/login', {
          ...
          alert(user + "," + is_admin); //액세스 토큰, 사용자 데이터 저장, localStorage앱 전반에 액세스 할 수 있도록한다
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  beforeMount: function beforeMount() {
    ...
    //렌더링 전 호출, 구성요소를 렌더링하는데 필요한 데이터를 가져옴
...
/***/ "./node_modules/css-loader/index.js?!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/views/SingleProduct.vue?vue&type=style&index=0&lang=css&":
/*!**************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader??ref--6-1!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src??ref--6-2!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/views/SingleProduct.vue?vue&type=style&index=0&lang=css& ***!
  \**************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./node_modules/style-loader/index.js!./node_modules/css-loader/index.js?!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/views/SingleProduct.vue?vue&type=style&index=0&lang=css&":
/*!******************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/style-loader!./node_modules/css-loader??ref--6-1!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src??ref--6-2!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/views/SingleProduct.vue?vue&type=style&index=0&lang=css& ***!
  \******************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {


var content = __webpack_require__(/*! !../../../node_modules/css-loader??ref--6-1!../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../node_modules/postcss-loader/src??ref--6-2!../../../node_modules/vue-loader/lib??vue-loader-options!./SingleProduct.vue?vue&type=style&index=0&lang=css& */ "./node_modules/css-loader/index.js?!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/views/SingleProduct.vue?vue&type=style&index=0&lang=css&");
    ...
    _c(
      ...
      [
        _c("a", { attrs: { href: "/admin/products" } }, [
          _vm._v("Orders (" + _vm._s(_vm.products.length) + ")")
        ])
      ]
    ),
    _vm._v(" "),
    _c(
      ...
      [
        _c("a", { attrs: { href: "/admin/users" } }, [
          _vm._v("Orders (" + _vm._s(_vm.users.length) + ")")
        ])
      ]
    )
  ])
...
var render = function() {
  ...
  var _c = _vm._self._c || _h
  return _c("div", [
    _c("table", { attrs: { clas: "table table-responsive table-striped" } }, [
      _vm._m(0),
      _vm._v(" "),
      _c(
        "tbody",
        _vm._l(_vm.orders, function(order, index) {
          return _c("tr", { key: index, on: { key: index } }, [
          ...
          [
            _vm._t("body", [
              ...
              _c("textarea", {
                ...
                attrs: { placeholder: "descriiption" },
...
var render = function() {
  ...
  return _c(
    "div",
    [
      _c("table", { staticClass: "table table-responseive table-striped" }, [
        _vm._m(0),
        _vm._v(" "),
        _c(
          "tbody",
        ...
        directives: [
          {
            name: "show",
            rawName: "v-show",
            value: _vm.editingIten != null,
            expression: "editingIten != null"
          }
        ],
...
var render = function() {
  ...
  return _c("div", [
    _c(
      "nav",
      { staticClass: "navbar navbar-expand-md navbar-light narbar-laravel" },
      [
        _c(
          "div",
          ...
          _vm.isLoggedIn
            ? _c("div", [
                _c(
                  "label",
                  {
                    staticClass: "clo-md-3 col-form-label",
                    attrs: { for: "address" }
                  },
                  [_vm._v("Dilivery Address")]
                ),
                _vm._v(" "),
      ...
      [
        _c(
          ...
          [
            ...
            _c("br"),
            _vm._v(" "),
            _c("span", { staticClass: "mudium-text" }, [
...
var staticRenderFns = [
  function() {
    ...
    return _c(
      ...
      [_c("h2", { staticClass: "title" }, [_vm._v("Welcome to the binStore")])]
    )
  }
]
render._withStripped = true
      ...
      _c(
        ...
        [
          ...
          _c(
            "router-link",
            {
              staticClass: "col-md-4 btn btn-primary float-right",
...
vue__WEBPACK_IMPORTED_MODULE_0___default.a.use(vue_router__WEBPACK_IMPORTED_MODULE_1__["default"]); //Vue.prototype.$ajax = axios
...
/* empty/unused harmony star reexport *//* harmony import */ var _SingleProduct_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./SingleProduct.vue?vue&type=style&index=0&lang=css& */ "./resources/js/views/SingleProduct.vue?vue&type=style&index=0&lang=css&");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
/***/ "./resources/js/views/SingleProduct.vue?vue&type=style&index=0&lang=css&":
/*!*******************************************************************************!*\
  !*** ./resources/js/views/SingleProduct.vue?vue&type=style&index=0&lang=css& ***!
  \*******************************************************************************/
/*! no static exports found */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_index_js_node_modules_css_loader_index_js_ref_6_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_2_node_modules_vue_loader_lib_index_js_vue_loader_options_SingleProduct_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/style-loader!../../../node_modules/css-loader??ref--6-1!../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../node_modules/postcss-loader/src??ref--6-2!../../../node_modules/vue-loader/lib??vue-loader-options!./SingleProduct.vue?vue&type=style&index=0&lang=css& */ "./node_modules/style-loader/index.js!./node_modules/css-loader/index.js?!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/views/SingleProduct.vue?vue&type=style&index=0&lang=css&");
/* harmony import */ var _node_modules_style_loader_index_js_node_modules_css_loader_index_js_ref_6_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_2_node_modules_vue_loader_lib_index_js_vue_loader_options_SingleProduct_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_style_loader_index_js_node_modules_css_loader_index_js_ref_6_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_2_node_modules_vue_loader_lib_index_js_vue_loader_options_SingleProduct_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_style_loader_index_js_node_modules_css_loader_index_js_ref_6_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_2_node_modules_vue_loader_lib_index_js_vue_loader_options_SingleProduct_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_style_loader_index_js_node_modules_css_loader_index_js_ref_6_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_2_node_modules_vue_loader_lib_index_js_vue_loader_options_SingleProduct_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
 /* harmony default export */ __webpack_exports__["default"] = (_node_modules_style_loader_index_js_node_modules_css_loader_index_js_ref_6_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_2_node_modules_vue_loader_lib_index_js_vue_loader_options_SingleProduct_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
__webpack_require__(/*! C:\Laravel\bigStore\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\Laravel\bigStore\resources\sass\app.scss */"./resources/sass/app.scss");
