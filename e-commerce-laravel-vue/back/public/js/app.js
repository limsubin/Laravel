...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__views_App__ = __webpack_require__(23);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__views_Login__ = __webpack_require__(32);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__views_Register__ = __webpack_require__(35);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__views_SingleProduct__ = __webpack_require__(38);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__views_Checkout__ = __webpack_require__(43);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__views_Confirmation__ = __webpack_require__(48);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__views_UserBoard__ = __webpack_require__(53);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__views_Admin__ = __webpack_require__(58);
    ...
    _c("div", { staticClass: "container" }, [
      _c(
        ...
        _vm._l(_vm.products, function(product, index) {
          return _c(
            "div",
            { key: index, staticClass: "col product-box", on: { key: index } },
            [
              _c(
                "router-link",
                ...
                [
                  ...
                  _c(
                    "button",
                    { staticClass: "col-md-4 btn btn-sm float-left" },
                    [_vm._v("Buy Now")]
                  )
                ]
              )
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    beforeMount: function beforeMount() {
        ...
        this.$http.get('/api/products/' + this.pid).then(function (response) {
            _this.product = response.data;
        }).catch(function (error) {
            console.error(error);
        });
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    beforeMount: function beforeMount() {
        ...
        this.$http.get('api/users/' + this.user.id + '/orders').then(function (response) {
                ...
                [
                  ...
                  _c("h5", [
                    ...
                    _c("span", { staticClass: "small-text text-muted" }, [
                      _vm._v(" " + _vm._s(order.product.price) + "원")
                    ])
                  ]),
                  _vm._v(" "),
                  _c("hr"),
                  ...
                  _c("span", { staticClass: "small-text text-muted" }, [
                    ...
                    _c("span", { staticClass: "float-right" }, [
                      _vm._v(
                        _vm._s(
                          order.is_delivered == 1 ? "배송 완료" : "배송 중"
                        )
                      )
                    ])
                  ]),
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        endEditing: function endEditing(product) {
            ...
            this.$http.put('/api/products/' + product.id, {
                name: product.name,
                units: product.units,
                price: product.price,
  ...
  methods: {
    ...
    uploadFile: function uploadFile(event) {
      ...
      if (this.attachment != null) {
        ...
        this.$http.post("/api/upload-file", formData, {
          headers: {
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        deliver: function deliver(index) {
            ...
            this.$http.patch('/api/orders/' + order.id + '/deliver').then(function (response) {
